...
RESOURCES += src/qt/icc.qrc src/qt/icc_locale.qrc

TRANSLATIONS += src/qt/locale/icc_bg.ts \
                src/qt/locale/icc_de.ts \
                src/qt/locale/icc_en.ts \
                src/qt/locale/icc_es.ts \
                src/qt/locale/icc_fi.ts \
                src/qt/locale/icc_fr.ts \
                src/qt/locale/icc_it.ts \
                src/qt/locale/icc_ja.ts \
                src/qt/locale/icc_pl.ts \
                src/qt/locale/icc_pt.ts \
                src/qt/locale/icc_ru.ts \
                src/qt/locale/icc_sk.ts \
                src/qt/locale/icc_sv.ts \
                src/qt/locale/icc_vi.ts \
                src/qt/locale/icc_zh_CN.ts \
                src/qt/locale/icc_zh_TW.ts
