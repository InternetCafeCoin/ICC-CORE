...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"icc", "listmasternodes", &listmasternodes, true, true, false},
        {"icc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"icc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"icc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"icc", "masternodedebug", &masternodedebug, true, true, false},
        {"icc", "startmasternode", &startmasternode, true, true, false},
        {"icc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"icc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"icc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"icc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"icc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"icc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"icc", "mnbudget", &mnbudget, true, true, false},
        {"icc", "preparebudget", &preparebudget, true, true, false},
        {"icc", "submitbudget", &submitbudget, true, true, false},
        {"icc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"icc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"icc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"icc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"icc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"icc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"icc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"icc", "checkbudgets", &checkbudgets, true, true, false},
        {"icc", "mnsync", &mnsync, true, true, false},
        {"icc", "spork", &spork, true, true, false},
        {"icc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"icc", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51578/\n";
}
