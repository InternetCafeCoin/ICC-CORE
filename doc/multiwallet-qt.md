...
In order to support loading of multiple wallets in icc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is icc.cpp.
...
Changes to icc.cpp
----------------------
icc.cpp is the entry point into icc-qt, and as such, will require some minor modifications to provide hooks for
