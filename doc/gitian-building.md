...
_Setup instructions for a gitian build of ICC using a Debian VM or physical system._
...
git clone https://github.com/icc-crypto/icc.git
cd icc
...
```bash
    ...
    From https://github.com/icc-crypto/icc
...
```bash
URL=https://github.com/crowning-/icc.git
