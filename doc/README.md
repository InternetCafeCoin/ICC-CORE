...
- icc-qt (GUI, 32-bit) or iccd (headless, 32-bit)
- icc-qt (GUI, 64-bit) or iccd (headless, 64-bit)
...
* Join one of our Discord group [ICC Discord Group](https://discord.gg/7rDuEwm).
...
Development
---------------------
The ICC repo's [root README](https://github.com/bouygues-coin/bouygues-core/blob/master/README.md) contains relevant information on the development process and automated testing.
...
* Join the Discord group [ICC Discord Group](https://discord.gg/7rDuEwm).
